...
break
		  ...
		  case 'tebakin': case 'tebakgambar':
                    ...
                    alpha.sendMessage(from, tebakya, image, { quoted: mek, caption: "Nih kak silahkan dijawab >< Waktunya 2 Menit" })
                   await sleep(120000)
				...
				case 'caklontong':
                    ...
                    console.log(jawaban)
                    alpha.sendMessage(from, tebak, text, { quoted: mek, caption: "Waktunya 2 Menit" })
                   await sleep(120000)
